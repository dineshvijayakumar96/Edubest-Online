...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO leap_apply_form_submissions (first_name, last_name, email, phone, college_university, country) VALUES (:first_name, :last_name, :email, :phone, :college_university, :country)";
        ...
        try {
            ...
            $mailer->isHTML(true);
            $mailer->Subject = 'L.E.A.P Apply Form Submission';

            // HTML Email Template
            $emailBody = "
                <html>
                <head>
                    <title>L.E.A.P Apply Form Submission</title>
                </head>
                <body>
                    <h1>L.E.A.P Apply Form Submission</h1>
