...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO software_apply_form_submissions (first_name, last_name, email, phone, college_university, country) VALUES (:first_name, :last_name, :email, :phone, :college_university, :country)";
        ...
        try {
            ...
            $mailer->isHTML(true);
            $mailer->Subject = 'Software Engineer Apply Form Submission';

            // HTML Email Template
            $emailBody = "
                <html>
                <head>
                    <title>Software Engineer Apply Form Submission</title>
                </head>
                <body>
                    <h1>Software Engineer Apply Form Submission</h1>
