...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO uiux_apply_form_submissions (first_name, last_name, email, phone, college_university, country) VALUES (:first_name, :last_name, :email, :phone, :college_university, :country)";
        ...
        try {
            ...
            $mailer->isHTML(true);
            $mailer->Subject = 'UIUX Designer Apply Form Submission';

            // HTML Email Template
            $emailBody = "
                <html>
                <head>
                    <title>UIUX Designer Apply Form Submission</title>
                </head>
                <body>
                    <h1>UIUX Designer Apply Form Submission</h1>
